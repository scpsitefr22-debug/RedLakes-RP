...
| 11+ | `Team` (générique, rattachée à `Department`), `PlayerAssignment` (historique polymorphe faction/département/team), `Sanction`, `Mission`+`MissionParticipant`, puis Wallet/Transaction, RpEvent, ClassifiedDocument, `FactionRelation` (diplomatie) — priorité et périmètre détaillés dans l'audit du 15/08/2026 (voir historique de conversation) | À venir |
