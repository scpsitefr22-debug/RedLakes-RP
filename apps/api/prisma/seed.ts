import { PrismaClient, LoreCategory, LoreStatus, UserRole } from "@prisma/client";
...
async function main() {
  ...
  const loreArticles = [
    {
      ...
      excerpt: "Le monde de REDLAKES où les anomalies sont réelles mais secrètes.",
      content:
    ...
    },
    {
      ...
      excerpt: "Complexe principal de REDLAKES avec 70+ grades et 4 départements.",
      content:
  ...
  const assets = [
    { title: "Brèche Secteur Keter", url: "/gallery/breach-keter.svg", faction: "Fondation SCP", type: "evenement" },
    { title: "Déploiement MTF Nu-7", url: "/gallery/mtf-nu7.svg", faction: "MTF", type: "evenement" },
    { title: "Confinement SCP-173", url: "/gallery/scp-173.svg", faction: "Fondation SCP", type: "scp" },
    { title: "Audit AEGIS Site-12", url: "/gallery/aegis-audit.svg", faction: "A.E.G.I.S.", type: "evenement" },
    { title: "Ville de REDLAKES", url: "/gallery/city.svg", faction: "Gouvernement", type: "screenshot" },
    { title: "Réseau d'Égouts", url: "/gallery/sewers.svg", faction: "Main du Serpent", type: "screenshot" },
  ];

  for (const asset of assets) {
    const existing = await prisma.galleryAsset.findFirst({ where: { title: asset.title } });
    if (!existing) {
