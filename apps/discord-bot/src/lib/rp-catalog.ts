...
export const STAFF_ROLE_PATTERNS: readonly RegExp[] = [
  ...
  /co-?fondateur/i, /developpeur/i, /developer/i, /\bdev\b/i, /bot\b/i,
  /verified|verifi/i, /^membre$/i, /^joueur$/i, /^visiteur$/i, /^civil$/i,
  /^nouveau/i, /^invite/i, /muted/i, /ping/i, /announcement/i,
  /everyone/i, /technique\s*staff/i, /gestion\s*staff/i, /🛠/, /🛡.*staff/i,
  /helper/i, /support/i, /animateur/i, /builder/i, /benevole/i, /bénévole/i,
  /équipe/i, /equipe/i, /gerant/i, /gérant/i, /community/i, /gestionnaire/i,
  /donateur/i, /donator/i, /\bvip\b/i, /perm(?:s|ission)?/i, /redlake\s*team/i,
  /chef\s*(?:du\s*)?serveur/i, /super-?admin/i,
];
